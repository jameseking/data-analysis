...
This is a true/false question, so I ran a two-sample proportion test to determine if 9th graders or 12th graders were more likely to be physically active at least 60 minutes per day on 5 or more days per week.
I excluded any 'NA' values, so my sample sets that I ran the proportion test on decreased to 3284 and 3009 for 9th and 12th graders versus the original sample set of sizes of 3479 and 3119.
